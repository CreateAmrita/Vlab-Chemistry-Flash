package org.papervision3d.objects.primitives {
        ...
        */
        public class CylinderTube extends TriangleMesh3D
        {
                /**
                ...
                */
                public function CylinderTube( material:MaterialObject3D=null, radius:Number=100, height:Number=100, segmentsW:int=8, segmentsH:int=6, topRadius:Number=-1, topFace:Boolean=true, bottomFace:Boolean=true, initObject:Object=null )
                {
                        ...
                        buildTube( radius, height, topRadius, topFace, bottomFace );
                }
        
                private function buildTube( fRadius:Number, fHeight:Number, fTopRadius:Number, fTopFace:Boolean, fBottomFace:Boolean ):void
                {
