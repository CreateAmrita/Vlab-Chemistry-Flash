package org.papervision3d.objects.primitives {
        ...
        */
        public class Pyramid extends TriangleMesh3D
        {
                /**
                ...
                */
                ...
                static public var ALL    :int = FRONT + BACK + RIGHT + LEFT + BOTTOM;
                ...
                */
                public function Pyramid( materials:MaterialsList, width:Number=500, depth:Number=500, height:Number=500, segmentsS:int=1, segmentsT:int=1, segmentsH:int=1, insideFaces:int=0, excludeFaces:int=0, initObject:Object=null )
                {
                ...
                */
                        ...
                        if( ! (excludeFaces & BOTTOM) )
                                buildPlaneBottom( "bottom", "x", "z", width, depth, -height2, ! Boolean( insideFaces & BOTTOM ) );
                ...
                private function buildPlane( mat:String, u:String, v:String, width:Number, height:Number, depth:Number, reverse:Boolean=false ):void
                {
                        ...
                        for( var iu:int = 0; iu < gridU1; iu++ )
                        {
                                ...
                                /*      var y :Number = iy * iH - textureY;
                                        var x :Number = (ix * iW - textureX)*Math.abs(1-(iy * iH)/height); */
                                        ...
                                        vertex[ u ] = (iu * incU - textureU) * rev*Math.abs(1-(iv * incV)/height);
                                        
                                        
                                        vertex[ w ] = depth*Math.abs(1-(iv * incV)/height);
                ...
                //Build Bottom of Plane
                
                
                private function buildPlaneBottom( mat:String, u:String, v:String, width:Number, height:Number, depth:Number, reverse:Boolean=false ):void
                {
                        var matInstance:MaterialObject3D;
                        if( ! (matInstance= materials.getMaterialByName( mat )))
                        {
