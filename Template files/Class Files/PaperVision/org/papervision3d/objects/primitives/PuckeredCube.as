package org.papervision3d.objects.primitives {
        ...
        */
        public class PuckeredCube extends TriangleMesh3D
        {
                //Curvature of the Puck
                ...
                */
                public function PuckeredCube( materials:MaterialsList,curvature:Number=2, width:Number=500, depth:Number=500, height:Number=500, segmentsS:int=1, segmentsT:int=1, segmentsH:int=1, insideFaces:int=0, excludeFaces:int=0, initObject:Object=null )
                {
        ...
        trace(matInstance);
                        ...
                        for( var iu:int = 0; iu < gridU1; iu++ )
                        {
                                for( var iv:int = 0; iv < gridV1; iv++ )
                                {
                                        ...
                                        vertex[ w ] = depth  +curvature*(1-vertex[u]*vertex[u]/(textureU*textureU))*(1-vertex[v]*vertex[v]/(textureV*textureV))* rev  ;
                                       
                                        }
                                       
                                       
                                        if(mat=="right"||mat=="left"){
                                       
                                        vertex[ w ] = depth  + curvature*(1-vertex[u]*vertex[u]/(textureU*textureU))* (1-vertex[v]*vertex[v]/(textureV*textureV))* rev  ;
                                       
                                        }
                                       
                                        if(mat=="front"||mat=="back"){
