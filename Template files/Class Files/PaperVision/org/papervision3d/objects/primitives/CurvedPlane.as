package org.papervision3d.objects.primitives {
        ...
        */
        public class CurvedPlane extends TriangleMesh3D
        {
                /**
                ...
                */
                public function CurvedPlane( material:MaterialObject3D=null, width:Number=0, height:Number=0, segmentsW:Number=0, segmentsH:Number=0, curvature:Number=0, initObject:Object=null )
                {
                ...
                private function buildPlane( width:Number, height:Number ):void
                {
                        ...
                        for( var ix:int = 0; ix < gridX + 1; ix++ )
                        {
                                for( var iy:int = 0; iy < gridY1; iy++ )
                                {
                                        ...
                                        //Video Curve
                        var z :Number = -myCurvature*(x*x/(width*width));
